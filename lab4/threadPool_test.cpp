...
//	// TODO
//	//Komentarz do maina
//	//Podejœcie konwencjonalne oferuje szybsze wykonanie zadanych obliczeñ.
//	//Zajmujemy jednak wiecej pamiêci.
//	//U¿ycie puli objektów wyd³u¿a operacjê obliczania ca³ki numerycznie.
//	// Zajmujemy za to mniej miejsca.
//
//	//create dataset
//	double dt = 0.1;
...
//		
//		std::cout << threadPool->GetInstance()->GetStatus();
//		
//		auto tstart = std::chrono::high_resolution_clock::now();
